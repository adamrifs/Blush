        ...
        <div className='w-full mt-5 overflow-hidden'>
            {
                loading ? (
                    <div className="flex md:w-[100%] md:h-[480px] gap-8 md:gap-0 overflow-x-auto scrollbar-hide items-center justify-evenly md:px-20 px-5 mt-8">
                        {[1, 2, 3, 4].map((i) => (
                            ...
                            >
                                {/* Image skeleton */}
                                <Skeleton
                                    height={160} // smaller screen height
                                    width={160}
                    ...
                    <div>
                        {/* ================ heading and see deals button ================== */}
                        <div className='flex md:w-[100%] items-center justify-between md:px-20 px-5'>
                            <h2 className='font-chopard md:text-[40px] text-[20px] w-[250px] md:w-auto '>The Secret to a Beautiful Home</h2>
                            <button className='flex items-center gap-2 bg-gradient-to-r from-[#b89bff] to-[#d6b8ff] border border-[#bca8ff] shadow-[0_2px_8px_rgba(0,0,0,0.1)] hover:from-[#a27aff] hover:to-[#cda5ff] hover:shadow-[0_4px_14px_rgba(107,70,193,0.3)] text-white md:px-6 md:py-3 px-3  py-2 text-xs md:text-[15px] font-montserrat rounded-[20px] cursor-pointer hover:bg-[#dddde0] transition duration-300'
                                onClick={() => gotoProductListing(null)}>See Deals<HiOutlineChevronRight /></button>
                        </div>
    ...
    "
        ...
        "
            ...
            "
                        ...
                        <div className='w-[90%] md:w-[70%] h-px bg-gray-200 mx-auto my-10'></div>
                    </div>
                )
            }
